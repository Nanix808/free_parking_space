...
class Stream(VideoStreamTrack):
    ...
    async def recv(self):
        ...
        results = self._model.predict(img, conf=self.conf, iou=self.iou, verbose=False)
    ...
    def plot_circles(self, img, results):
        ...
        for circle in circles:  
            if 'available' in circle.keys():
                cv2.circle(img, (circle['x1'],circle['y1']), int(circle['rad']), (255, 0, 0), -1)
            
            else:
                free += 1
                cv2.circle(img, (circle['x1'],circle['y1']), int(circle['rad']), (0, 255, 0), -1)  
        return free
    ...
    def plot_bboxes(self, image, boxes, labels=[], colors=[], score=True, conf=None):
        ...
        if colors == []:
            colors = [(6, 112, 83), (253, 246, 160), (40, 132, 70), (205, 97, 162), (149, 196, 30),
                    (106, 19, 161), (127, 175, 225), (115, 133, 176), (83, 156, 8), (182, 29, 77),
                    (180, 11, 251), (31, 12, 123), (23, 6, 115), (167, 34, 31), (176, 216, 69),
                    (110, 229, 222), (72, 183, 159), (90, 168, 209), (195, 4, 209), (135, 236, 21),
                    (62, 209, 199), (87, 1, 70), (75, 40, 168), (121, 90, 126), (11, 86, 86),
                    (40, 218, 53), (234, 76, 20), (129, 174, 192), (13, 18, 254), (45, 183, 149),
                    (77, 234, 120), (182, 83, 207), (172, 138, 252), (201, 7, 159), (147, 240, 17),
                    (134, 19, 233), (202, 61, 206), (177, 253, 26), (10, 139, 17), (130, 148, 106),
                    (174, 197, 128), (106, 59, 168), (124, 180, 83), (78, 169, 4), (26, 79, 176),
                    (185, 149, 150), (165, 253, 206), (220, 87, 0), (72, 22, 226), (64, 174, 4),
                    (245, 131, 96), (35, 217, 142), (89, 86, 32), (80, 56, 196), (222, 136, 159),
                    (145, 6, 219), (143, 132, 162), (175, 97, 221), (72, 3, 79), (196, 184, 237),
                    (18, 210, 116), (8, 185, 81), (99, 181, 254), (9, 127, 123), (140, 94, 215),
                    (39, 229, 121), (230, 51, 96), (84, 225, 33), (218, 202, 139), (129, 223, 182),
                    (167, 46, 157), (15, 252, 5), (128, 103, 203), (197, 223, 199), (19, 238, 181),
                    (64, 142, 167), (12, 203, 242), (69, 21, 41), (177, 184, 2), (35, 97, 56),
                    (241, 22, 161)]
